...
namespace InvoiceReport
{
    ...
    public partial class InvoiceReport : Form
    {
        ...
        private void SendEmail(string fileLocation)
        {
            ...
            mail.Subject = "AP Aging - KMKDAT - " + DateTime.Now.ToString("yyyy'-'MM'-'dd'_'HH'-'mm'-'ss");
            mail.Body = "";

            Attachment attachment;
            attachment = new Attachment(fileLocation);
            attachment.ContentDisposition.FileName = "AP Aging - KMKDAT - " + DateTime.Now.ToString("yyyy'-'MM'-'dd'_'HH'-'mm'-'ss") + ".xlsx";
