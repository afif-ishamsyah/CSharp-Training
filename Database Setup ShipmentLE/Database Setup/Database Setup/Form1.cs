...
namespace Database_Setup
{
    ...
    {
        string fileName = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Save/DatabaseSetupShipmentLE.txt";
        ...
        private void SetupCMWTRN_Load(object sender, EventArgs e)
        {
            ...
            {
                Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Save");
            }
