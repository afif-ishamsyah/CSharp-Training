...
namespace Application_Setup
{
    ...
    {
        //string fileName = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Kapan Lagi/Order Entry/Save/DatabaseSetupOrderEntryKLY.txt";
        string fileName = "E:/Sage/Interface/KAPAN LAGI DOT COM/Module/Order Entry/Order Entry/DatabaseSetupOrderEntryKLY.txt";
        ...
        private void File_Load()
        {
            ...
            {
                //Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Kapan Lagi/Order Entry/Save");
                Directory.CreateDirectory("E:/Sage/Interface/KAPAN LAGI DOT COM/Module/Order Entry/Order Entry");
            }
