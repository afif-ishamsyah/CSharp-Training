...
namespace Database_Setup
{
    ...
    {
        string fileName = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/KapanLagi/Save/DatabaseSetupShipmentKL.txt";
        ...
        private void SetupCMWTRN_Load(object sender, EventArgs e)
        {
            ...
            {
                Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/KapanLagi/Save");
            }
