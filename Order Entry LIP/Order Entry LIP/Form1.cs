...
namespace Order_Entry_LE
{
    public partial class OrderEntryLIP : Form
    {
        ...
        private void OrderEntryLIP_Load(object sender, EventArgs e)
        {
            LoadSaveFile();
        ...
        private void SendtoSage()
        {
            try
            {
                ...
                while (tfp.EndOfData == false)
                {
                    ...
                    if (numrow == 1)
                    {
                        //string sequenceLocation = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Order Entry/Save/Sequence.txt";
                        string sequenceLocation = "E:/Sage/Interface/LIPUTAN ENAM DOT COM PT/Module/Order Entry/Order Entry/Sequence.txt";
        ...
        private void LoadSaveFile()
        {
            try
            {
                //string fileload = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Order Entry/Save/DatabaseSetupOrderEntryLIP.txt";
                string fileload = "E:/Sage/Interface/LIPUTAN ENAM DOT COM PT/Module/Order Entry/Order Entry/DatabaseSetupOrderEntryLIP.txt";
                string[] lines;
