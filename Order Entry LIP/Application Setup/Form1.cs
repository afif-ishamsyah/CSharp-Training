...
namespace Application_Setup
{
    ...
    {
        //string fileName = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Order Entry/Save/DatabaseSetupOrderEntryLIP.txt";
        string fileName = "E:/Sage/Interface/LIPUTAN ENAM DOT COM PT/Module/Order Entry/Order Entry/DatabaseSetupOrderEntryLIP.txt";
        ...
        private void File_Load()
        {
            ...
            {
                //Directory.CreateDirectory(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Interface Sage/Liputan Enam/Order Entry/Save");
                Directory.CreateDirectory("E:/Sage/Interface/LIPUTAN ENAM DOT COM PT/Module/Order Entry/Order Entry");
            }
