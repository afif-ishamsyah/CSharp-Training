...
{
    public partial class PasswordEncrypt : Form
    {
        ...
        {
            string path = "E:/Sage/Auto Generate Reports/-- Password Generator --/Pass.txt";
            string encryptedString = Encrypt(PasswordTextbox.Text, passphrase);
            File.WriteAllText(path, encryptedString);
        }

        private void PasswordEncrypt_Load(object sender, EventArgs e)
        {
